...
For the first task all you need to do is while running Yara run at the same time that malware 'MerryChristmas.exe' and after that you'll be getting a popup with the 1st flag

For the second task you will need to simply provide to floss.exe the above mentioned malware file and then find the hidden flag.
